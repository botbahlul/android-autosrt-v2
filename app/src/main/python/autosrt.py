                ...
                if ffmpeg_src_language_code not in subtitle_stream_parser.languages() and ffmpeg_dst_language_code in subtitle_stream_parser.languages():
                    ...
                    if dst_subtitle_stream_timed_subtitles and dst_subtitle_stream_timed_subtitles != []:
                        ...
                        for i, translated_subtitle_stream_transcript in enumerate(pool.imap(transcript_translator, subtitle_stream_transcripts)):
                            ...
                            pbar(progress, translate_start_time, 100, f"Translating subtitles to '{src}'", activity, textview_progress, progress_bar, textview_percentage, textview_time)
                        pbar(100, translate_start_time, 100, f"Translating subtitles to '{src}'", activity, textview_progress, progress_bar, textview_percentage, textview_time)
                        time.sleep(1)
                ...
                # so we translate it from 'src' to 'dst'
                    ...
                    if src_subtitle_stream_timed_subtitles and src_subtitle_stream_timed_subtitles != []:
                        ...
                        for i, translated_subtitle_stream_transcript in enumerate(pool.imap(transcript_translator, subtitle_stream_transcripts)):
                            ...
                            pbar(progress, translate_start_time, 100, f"Translating subtitles to '{dst}'", activity, textview_progress, progress_bar, textview_percentage, textview_time)
                        pbar(100, translate_start_time, 100, f"Translating subtitles to '{dst}'", activity, textview_progress, progress_bar, textview_percentage, textview_time)
                        time.sleep(1)
